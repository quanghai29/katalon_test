...
WebUI.navigateToUrl(findTestData('CreateNewChanel').getValue(1, 6))
...
WebUI.setText(findTestObject('Page_Town Square - hello dung Mattermost/input_Name_newChannelName'), findTestData('CreateNewChanel').getValue(
        6, 6))
