...
def data = findTestData('SignUp_EmailInvalid_CSV')
...
for (def index : (1..data.getRowNumbers())) {
	...
	def warning = WebUI.getText(findTestObject('Object Repository/SignUp/Page_1/Page_Mattermost/label_Please enter a valid email address'))
